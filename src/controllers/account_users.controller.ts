...
import { CreateAccountUserDto } from '@dtos/account_users.dto';
import AccountUsersService from '@services/account_users.service';

class AccountUsersController {
    public accountUserService = new AccountUsersService();
...
export default AccountUsersController;